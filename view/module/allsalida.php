<?php
        ...
        class Reporte{
            ...
            public function headReport(){
             ...
             $this -> pdf->Cell(80);
             // Título
             $this -> pdf->Cell(30,10,'Reporte Salida',0,0,'C');
             // Salto de línea
             $this -> pdf ->Ln(20);

             $this->pdf->cell(25,10,'Id_Salida',1,0,'C',0);
            ...
            foreach($respon as $key => $value){
                ...
                $this -> pdf->Cell(25,10,$value['Id_Salida'],1,0,'C',0);
        ...
        public function footReport(){
            ...
            // Arial italic 8
             ...
             // Número de página
            $this->pdf->Cell(0,10,'Page '.$this->pdf->PageNo().' Reporte salida',0,0,'C');
            $this -> pdf ->Output(); 
        }
