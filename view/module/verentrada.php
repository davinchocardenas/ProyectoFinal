        ...
        <table id="users" class="table table-dark table-striped table-hover">
          ...
          <tbody>
            <form method="post">
              ...
              if (gettype($objCtrEntrada->getSearchAllEntrada()) == 'boolean') {
                echo '
                <tr>
                ...
                foreach ($objCtrEntrada->getSearchAllEntrada() as $key => $value) {
                  echo '
                  <tr>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" id="frmEntradaM">
          <input type="hidden" name="txtId_Entrada" id="txtId_Entrada">
              <div class="box-body">
